...
const seedComments = async () => {
    try {
        ...
        const commentsData = [
            ...
            makeComment("پروژه فروشگاهی آخر دوره عالی بود. کلی چیز یاد گرفتم.", 5, safe(2), 0),

            // ==================== Python Django (course[1]) ====================
            makeComment("Django واقعاً قدرتمنده. ممنون از دوره خوبتون. پروژه‌ها خیلی کاربردی بودن.", 5, safe(6), 1),
            makeComment("بخش Celery یکم پیچیده بود. مثال بیشتری می‌خواست.", 3, safe(4), 1, "چشم، حتماً توی آپدیت اضافه می‌کنیم. 📚"),
            ...
            makeComment("کیفیت صدا توی بعضی جلسات افت داره. لطفاً درستش کنید.", 3, safe(7), 2, "چک می‌کنیم و دوباره ضبط می‌کنیم. 🎙️"),
            makeComment("قیمتش نسبت به محتوا یکم زیاده. دوره‌های مشابه ارزون‌تر هستن.", 2, safe(9), 2, "تخفیف‌های مناسبتی داریم. 😉"),
            makeComment("جاوا کار میکردم، کاتلین رو با این دوره یاد گرفتم.", 4, safe(11), 2),

            // ==================== Frontend (course[3]) ====================
            makeComment("مسیر فرانت‌اند رو کامل یاد گرفتم. از HTML تا JavaScript همه چی عالی بود.", 5, safe(1), 3),
            ...
            makeComment("بعد از این دوره تونستم توی شرکت خودمون تست نفوذ انجام بدم.", 5, safe(4), 4),
            ...
            makeComment("بخش Subnetting رو خوب توضیح دادین.", 4, safe(1), 6),
            ...
            makeComment("با این دوره تونستم یه پروژه واقعی بزنم.", 5, safe(2), 8),
