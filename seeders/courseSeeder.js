...
const seedCourses = async () => {
    try {
        ...
        const courses = [
            ...
            { name: "آموزش Python و Django", href: "python-django-course", description: "پایتون و Django رو از پایه یاد بگیر. REST API، PostgreSQL، Celery و deployment.", price: 549000, status: "published", categoryID: catMap["Backend"], creator: admin._id, teacher: teacher[2]._id, cover: "django.jpg" },
